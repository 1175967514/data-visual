    ...
    <el-dialog :title="info.title" :visible.sync="Dialog" @close='closeDialog'>
      <el-row>
        <el-col :span="4">
          ...
          <el-row>
            <el-col :span="24">
              <span class="title"> 当前长度：{{info.dqcd}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 满管长度：{{info.dclscd}}</span>
            </el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
         ...
         <el-col :span="4">
          <el-row>
            <el-col :span="24">
              <span class="title"> 锭速：{{info.dzzs}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 捻速：{{info.yznd}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
          ...
          <el-row>
            <el-col :span="24">
              <span class="title"> 设定捻速：{{info.sdnd}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 运转锭速状态：{{info.yzdslx}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 捻速偏差状况：{{info.ndpczk}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
...
export default {
  ...
  watch: {
    xiShaNewestState: {
      ...
      handler(val) {
        ...
        this.info.title = val.data.devSn+ "号细纱DTM129 详情";
  ...
  methods: {
    ...
    showDialog(data) {
      this.data = data;
      // this.title = data.id + "号细纱DTM129 详情";
      this.Dialog = true;
      this.$nextTick(() => {
        this.init1();
        this.init2();
        ...
        series: [
          {
            ...
            data: [
              {
                name: "效率",
                value: (this.info.runTime/this.info.totalTime)*100,
              },
            ],
          },
        ],
