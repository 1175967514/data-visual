    ...
    <el-dialog :title="title" :visible.sync="Dialog">
      <el-row>
        <el-col :span="4">
          ...
          <el-row>
            <el-col :span="24">
              <span class="title"> 棉箱喂棉速度：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 刺辊速度：</span>
            </el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="4">
          <el-row>
            <el-col :span="24">
              <span class="title">标准压力设定：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 开松辊转速：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 盖板速度：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
          ...
          <el-row>
            <el-col :span="24">
              <span class="title"> 当前棉箱压力：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 当前棉层压力：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 锡林速度：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 道夫速度：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
...
export default {
  ...
  methods: {
    showDialog(data) {
      this.data = data;
      this.title = data.id + "号开棉机JWF1159 详情";
      this.Dialog = true;
      this.$nextTick(() => {
        this.init1();
        this.init2();
