<template>
  <div class="dialog">
    <!-- 络筒弹窗控件 -->
    <el-dialog :title="info.title" :visible.sync="Dialog" @close='closeDialog'>
      <el-row>
        <el-col :span="4">
          <el-row>
            <el-col :span="24">
          ...
          <el-row>
            <el-col :span="24">
              <span class="title"> 当前班产：</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 空转：{{info.kz}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 一落纱长：{{info.ylsc}}</span>
            </el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
          <el-row>
            ...
            <el-col :span="24">
              <span class="title"> 纺纱定长：</span>
            </el-col>
            <el-col :span="24"> <span class="title"> 位置检测：</span> </el-col>
          </el-row>
        </el-col>
        <el-col :span="8">
          <el-row>
            ...
            <el-col :span="24">
              <span class="title"> UC5读数：</span>
            </el-col>
            <el-col :span="24"> <span class="title"> 挡车工：</span> </el-col>
          </el-row>
        </el-col>
        <el-col :span="4">
          <el-row>
            <el-col :span="24">
              <span class="title"> 换向上限：{{info.hxsx}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 换向下限：{{info.hxxx}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 换向次数：{{info.hxcs}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 罗拉转速：{{info.llzs/100}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 锭速：{{info.dyzs}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 捻度：{{info.dyzs/info.llxs}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 满管长度：{{info.fsdc}}</span>
            </el-col>
          </el-row>
        </el-col>
      </el-row>
...
export default {
  ...
  computed: {
    txcsomlNewestState() {
      return this.$store.state.txcsomlNewestState;
    }
  },
  watch: {
    txcsomlNewestState: {
      ...
      handler(val) {
        ...
        this.info.title = val.data.devSn+ "号粗纱机467E 详情";
  ...
  methods: {
    ...
    showDialog(data) {
      this.data = data;
      this.title = data.id + "号粗纱机467E 详情";
      this.Dialog = true;
      this.$nextTick(() => {
        this.init1();
        this.init2();
