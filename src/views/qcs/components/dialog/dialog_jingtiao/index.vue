    ...
    <el-dialog :title="info.title" :visible.sync="Dialog" @close='closeDialog'>
      <el-row>
        ...
        <el-col :span="4">
          <el-row>
            <el-col :span="24">
              <span class="title"> 速度：{{info.sd}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 余长：{{info.yc}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 低速速度：{{info.dssd}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <span class="title"> 满筒长度：{{info.dc}}</span>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
...
export default {
  ...
  computed: {
    bingTiaoNewestState() {
      return this.$store.state.bingTiaoNewestState;
    }
  },
  watch: {
    bingTiaoNewestState: {
      ...
      handler(val) {
        ...
        this.info.title = val.data.devSn+ "号井条机JWF1009 详情";
  ...
  methods: {
    ...
    showDialog(data) {
      this.data = data;
      this.title = data.id + "号井条机JWF1009 详情";
      this.Dialog = true;
      this.$nextTick(() => {
        this.init1();
        this.init2();
