    ...
    <el-tooltip placement="top">
      ...
      >
        ...
        <path
          ...
          data-name="矩形 1"
          class="cls-1"
          d="M45,1h2A31,31,0,0,1,78,32V74a0,0,0,0,1,0,0H14a0,0,0,0,1,0,0V32A31,31,0,0,1,45,1Z"
        />
        <path
          :style="bodyStyle"
          id="矩形_1_拷贝_2"
          data-name="矩形 1 拷贝 2"
          class="cls-2"
          d="M249,463h64V927.875H249V463Zm0,53.875v-24.75M236,475h15v41H236V475Z"
        ...
        <path
          ...
          data-name="矩形 3"
          class="cls-4"
          d="M14,535H78a0,0,0,0,1,0,0v46a4,4,0,0,1-4,4H18a4,4,0,0,1-4-4V535A0,0,0,0,1,14,535Z"
        />
      </svg>
    </el-tooltip>
  </div>
